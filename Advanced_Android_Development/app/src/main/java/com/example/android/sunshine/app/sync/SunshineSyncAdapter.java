...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks,
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                if (i == 0) {
                    ...
                    putDataMapReq.getDataMap().putDouble("LowTemp", low);
                    putDataMapReq.getDataMap().putDouble("HighTemp", high);
                    Bitmap bitmap = BitmapFactory.decodeResource(getContext().getResources(),
                            Utility.getArtResourceForWeatherCondition(weatherId));
                    Asset asset = createAssetFromBitmap(bitmap);
                    putDataMapReq.getDataMap().putAsset("WeatherAsset", asset);
                        ...
                        pendingResult.setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                            ...
                            public void onResult(@NonNull DataApi.DataItemResult dataItemResult) {
                                if (dataItemResult.getStatus().isSuccess()) {
                                    Log.e("SyncAdpater", "onResult: ");
                                    Log.e("SyncAdpater", dataItemResult.getDataItem().toString());
                                } else {
                                    Log.e("SyncAdpater", "on not success: ");
                                }
    ...
    public static void configurePeriodicSync(Context context, int syncInterval, int flexTime) {
        Log.e("static", "configurePeriodicSync: ");
    ...
    public static void initializeSyncAdapter(Context context) {
        Log.e("initialize", "initializeSyncAdapter: ");
